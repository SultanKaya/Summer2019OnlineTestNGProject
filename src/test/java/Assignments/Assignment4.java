...
public class Assignment4 {
    ...
    public void test2() {
        ...
        gridButton.click();
        BrowserUtils.wait(1);
        List<WebElement> checkboxes = driver.findElements(By.xpath("//table[@class='grid table-hover table table-condensed']//tr//td[3]"));
        for (int i = 1; i < checkboxes.size(); i++) {
            checkboxes.get(i).click();
            BrowserUtils.wait(1);
        }
        WebElement title = driver.findElement(By.xpath("//table[@class='grid table-hover table table-condensed']//tr//td[3]"));
    ...
    public void test3() {
        WebElement createEvent = driver.findElement(By.xpath("//a[@class='btn main-group btn-primary pull-right ']"));
        createEvent.click();
        WebElement loaderMask = driver.findElement(By.cssSelector("div[class='loader-mask shown']"));
        wait.until(ExpectedConditions.invisibilityOf(loaderMask));
        driver.findElement(By.xpath("//a[@class='btn-success btn dropdown-toggle']")).click();
        BrowserUtils.wait(1);//for demo
        List<WebElement> lists = driver.findElements(By.xpath("//ul[@data-options='{\"align\": \"right\", \"attachToParent\": \"true\"}']"));

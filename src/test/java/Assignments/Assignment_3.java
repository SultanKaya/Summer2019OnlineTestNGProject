...
public class Assignment_3 {
    ...
    public void test4() {
        List<WebElement> elements = driver.findElements(By.xpath("//table//body//tr"));
        ...
        Assert.assertTrue(numberOfEvents.contains(numberOfRecordsString), "record amount is wrong");
